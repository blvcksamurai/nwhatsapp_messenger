...
import 'package:not_whatsapp_lol/common/helper/show_loading_dialog.dart';
import 'package:not_whatsapp_lol/common/models/user_model.dart';
import 'package:not_whatsapp_lol/common/repository/firebase_storage_repository.dart';
...
class AuthRepository {
  ...
  void verifySmsCode({
    ...
    try {
      showLoadingDialog(
          context: context, message: 'Code Verification in progress...');
