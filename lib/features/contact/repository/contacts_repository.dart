...
class ContactsRepository {
  ...
  Future<List<List>> getAllContacts() async {
    // These are contacts that are saved in the user's phone and has an account
    List<UserModel> firebaseContacts = [];
    //These are contacts that are contacts that aere saved in the user's phone and does not have an account
